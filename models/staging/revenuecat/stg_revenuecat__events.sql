...
renamed as (
    ...
    select
        ...
        -- Extracted from SUPER type raw_payload
        json_extract_path_text(raw_payload, 'is_family_share', true)::boolean
                                                               as is_family_plan,
        json_extract_path_text(raw_payload, 'cancel_reason', true)::text
                                                               as cancel_reason,
